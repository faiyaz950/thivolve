...
import { CheckCircle, Linkedin, Quote, ArrowRight, Users, Target, Heart, Award } from 'lucide-react';
...
const CultureFeature = ({ icon: Icon, title, description, index, isVisible }: {
...
const cultureImages = [
  ...
  { src: '/officefour.jpeg', alt: 'Modern office interior' },
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        {/* Animated elements */}
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary/10 rounded-full filter blur-3xl animate-pulse" style={{ animationDuration: '6s' }} />
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className={cn(
            ...
            <div className="grid grid-cols-2 gap-6">
              {/* Image 1 */}
              <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/5 to-transparent backdrop-blur-sm hover:border-white/20 transition-all duration-700 hover:scale-105">
                <Image
                  src={cultureImages[0].src}
                  alt={cultureImages[0].alt}
                  width={400}
                  height={300}
                  className="w-full h-48 object-cover transition-all duration-700 group-hover:scale-110 filter group-hover:brightness-110"
                />
              ...
              {/* Image 2 - Tall */}
              <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/5 to-transparent backdrop-blur-sm row-span-2 hover:border-white/20 transition-all duration-700 hover:scale-105">
                <Image
            ...
            <div className="absolute -bottom-4 -left-4 w-6 h-6 bg-gradient-to-br from-white/10 to-transparent rounded-xl border border-white/20 animate-pulse backdrop-blur-sm" style={{ animationDelay: '1s' }} />
          </div>
        </div>
      </div>
    </section>
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        {/* Animated background */}
        <div className="absolute inset-0 opacity-20">
          <div className="absolute bottom-1/3 right-1/3 w-80 h-80 bg-primary/10 rounded-full filter blur-3xl animate-pulse" style={{ animationDuration: '8s' }} />
        </div>
      </div>
