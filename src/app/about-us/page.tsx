...
<div className="relative w-48 h-48 mx-auto rounded-full overflow-hidden border-4 border-primary/20 group-hover:border-primary/40 transition-all duration-500 group-hover:scale-110">
<Image
src={member.image}
...
<div
    ...
    <div className="relative bg-gradient-to-br from-neutral-800/20 via-neutral-900/30 to-black/40 backdrop-blur-xl rounded-3xl border border-white/5 p-6 md:p-10 overflow-hidden hover:border-white/10 transition-all duration-700">
        ...
        <div className="relative space-y-6 text-base md:text-lg text-neutral-300 leading-relaxed">
            <p>
Thivolve Global Private Limited (TGPL) is a certified organization in India. Formerly operating as Witech, a proprietorship firm, we transformed into a private limited company to drive growth and enhance client satisfaction.
            </p>
