...
const projectsData: Project[] = [
  ...
  {
    imageUrl: 'https://images.unsplash.com/photo-1516110833953-7a9b152fa2a4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
    aiHint: 'ai chatbot customer service',
    category: 'AI Services',
    title: 'AI Chatbot for E-commerce',
    description: 'An intelligent chatbot to automate customer support and boost sales.',
    detailedDescription: 'We developed a sophisticated AI chatbot for a leading e-commerce platform to handle customer queries 24/7. The chatbot uses natural language processing (NLP) to understand and respond to user inquiries, resolve common issues, and escalate complex problems to human agents. It also provides personalized product recommendations.',
    problemStatement: 'The client was facing high operational costs and slow response times in their customer support department, leading to poor customer satisfaction and lost sales opportunities.',
    solution: 'We built a custom chatbot using Rasa and integrated it with their existing CRM and e-commerce platform. The bot was trained on historical customer service data to handle a wide range of queries, from order tracking to return requests. We also integrated a recommendation engine to suggest products based on user behavior.',
    results: '50% reduction in support tickets | 15% increase in conversion rate',
    technologies: ['Rasa', 'Python', 'NLP', 'Docker', 'Kubernetes'],
    duration: '4 months',
    href: '#',
  },
  {
    imageUrl: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
    aiHint: 'project management software',
    category: 'Custom Software Development',
    title: 'Project Management SaaS Platform',
    description: 'A collaborative platform for teams to manage projects, tasks, and deadlines.',
    detailedDescription: 'A full-fledged SaaS application that allows teams to plan, execute, and monitor projects in a collaborative environment. The platform includes features like task management, Gantt charts, time tracking, and team communication.',
    problemStatement: 'The client, a startup, wanted to create a project management tool that was more intuitive and affordable than existing solutions on the market, targeting small to medium-sized businesses.',
    solution: 'We developed a multi-tenant SaaS platform using a microservices architecture. The frontend was built with Vue.js for a reactive user experience, while the backend was powered by Node.js and Express. We used websockets for real-time collaboration features and integrated Stripe for subscription billing.',
    results: 'Acquired 1,000+ paying customers within the first year',
    technologies: ['Vue.js', 'Node.js', 'MongoDB', 'WebSocket', 'Stripe'],
    duration: '10 months',
    href: '#',
  },
  {
    imageUrl: 'https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
    aiHint: 'data analytics dashboard',
    category: 'Web Application',
    title: 'Real-time Analytics Dashboard',
    description: 'A web-based dashboard for visualizing and analyzing business data in real-time.',
    detailedDescription: 'A custom data visualization tool that connects to multiple data sources and displays key business metrics in an interactive and easy-to-understand dashboard. It helps stakeholders make informed decisions by providing a live snapshot of business performance.',
    problemStatement: 'The client had data scattered across various platforms (CRM, sales software, etc.) and lacked a centralized way to monitor performance, making it difficult to react quickly to market changes.',
    solution: 'We built a web application using React and D3.js for data visualization. The backend was developed in Python to handle data aggregation from various APIs. The dashboard features customizable widgets, drill-down capabilities, and automated email reports.',
    results: 'Reduced report generation time by 90%',
